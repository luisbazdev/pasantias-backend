...
router.get("/historiales", authMiddleware, async (req: any, res: any) => {
  ...
  router.get("/historiales/:id", authMiddleware, async (req: any, res: any) => {
    try {
      const { id } = req.params;
  ...
  router.post("/historiales", authMiddleware, async (req: any, res: any) => {
    const {
      embarazos,
      historial_embarazada,
      numero_de_historia   ,
  ...
  router.put("/historiales/:id", authMiddleware, async (req: any, res: any) => {
    try {
      const { id } = req.params;
  ...
  router.delete("/historiales/:id", authMiddleware, async (req: any, res: any) => {
    try {
      const { id } = req.params;
